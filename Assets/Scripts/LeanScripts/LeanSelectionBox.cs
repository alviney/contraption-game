...
namespace Lean.Touch
{
    ...
    public class LeanSelectionBox : MonoBehaviour
    {
        ...
        {
            // +++++    I added this to check if finger was over a translateable object
            ...
            if (camera != null)
            {
                ...
                // Set this layer mask to the objects I want this to escape on.
            ...
            PartsManager.instance.SetIsDragging(true);
        }
        ...
        private void FingerUp(LeanFinger finger)
        {
            ...
            if (link != null)
            {
                ...
                PartsManager.instance.SetIsDragging(false);
            }
        }
