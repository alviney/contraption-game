...
namespace Lean.Touch
{
	...
	public class LeanTranslate : MonoBehaviour
	{
		...
		protected virtual void Start()
		{
			...
			Contraption = transform.parent.GetComponent<Contraption>();
		}
		...
		protected virtual void Translate(Vector2 screenDelta)
		{
			...
			if (camera != null)
			{	
				if (!Contraption.editing) {
					// Screen position of the transform
					var screenPoint = camera.WorldToScreenPoint(transform.parent.transform.position);
